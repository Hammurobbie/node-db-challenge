...
Relational Databases are databases where similiar data is grouped in tables. SQL is the language used to work with RDs.

- [ ] Why do tables need a `primary key`?

A primary key is a unique id to prevent duplicates of data.
...
Several foreign keys on the respective tables that reference each other
